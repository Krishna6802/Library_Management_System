...
public class MyBookAdapter extends RecyclerView.Adapter<MyBookAdapter.MyViewHolder> {
    ...
    public MyBookAdapter(Context context, ArrayList book_id, ArrayList book_title, ArrayList book_author, ArrayList book_lang, ArrayList book_publication, ArrayList book_edition, ArrayList book_pages) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.admin_book_data,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int result = db.delBook(String.valueOf(book_id.get(position)));
                if(result > 0)
                {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, AdminEditBookActivity.class);
